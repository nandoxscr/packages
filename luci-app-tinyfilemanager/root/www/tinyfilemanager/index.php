...
<script src="jquery/bootstrap.slim.min.js"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .main-nav { padding:0.2rem 1rem;rgba(0, 0, 0, .14), 0 1px 10px 0 rgba(0, 0, 0, .12), 0 2px 4px -1px rgba(0, 0, 0, .2)  }
...
<script src="jquery/absolute.js"></script>
<script src="jquery/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
